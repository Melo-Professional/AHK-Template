...
;@Ahk2Exe-SetMainIcon %U_appnameclean%.ico
;@Ahk2Exe-AddResource %U_appnameclean%.ico, 160
;@Ahk2Exe-AddResource %U_appnameclean%.ico, 206
;@Ahk2Exe-AddResource %U_appnameclean%_Pause.ico, 207
;@Ahk2Exe-AddResource %U_appnameclean%.ico, 208
