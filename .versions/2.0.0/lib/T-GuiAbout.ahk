...
;    MyGui.Add("Text", "x+15 y40 vStrong_Title c" . colors.TextStrong, App.Name)
...
MyGui.Add("Text", "y+2 vSmooth_Version", "Version " App.Version)
    ...
    ; 4. Credits / Copyright
    MyGui.SetFont("s" Settings.GuiFontSizeSmall " w400")
    MyGui.Add("Text", "x" MyGui.MarginX " y+20 vSmooth_Credits", App.Copyright)
...
MyGui.AddButton("x" (GuiWidth - MyGui.MarginX - BtnWidth) " y+25 w" BtnWidth " h30 Default", "&OK").OnEvent("Click", CleanDestroy)
   ...
   MyGui.Show()
   CleanDestroy(*) {
         RemoveGuiFromArray(MyGui) ; Remove do array global
         MyGui.Destroy()           ; Fecha a janela
      }
}
