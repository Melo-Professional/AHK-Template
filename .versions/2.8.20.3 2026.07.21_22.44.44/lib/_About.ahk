...
ShowAboutGUI() {
    ...
    ; 1. Icon
    try {
        MyGui.Add("Picture", "xm y+5 w64 h-1", App.Icon)
    } catch {
        MyGui.SetFont("s22 w500")
        MyGui.Add("Text", "xm y+5 w64 h64", "[ i ]")
    }
    ...
    if UseAcrylicGUI {
        ...
        btnSave := MyGui.Add("Text", "x" btnX " y+10 w" BtnWidth " h30 Center 0x0200 Background" BGroundNormalColor " +Border", "OK")
